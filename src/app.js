...
function generateItinerary(event){
  ...
  let instructionsInput = document.querySelector("#user-instructions");
   ...
   let prompt = `user instructions are: please generate a short 3 day itinerary. When writing the itinerary put a <br> HTML element after each day, put the days in <strong></strong> HTML element. ${instructionsInput.value}`;
   let context =
     " You are a very knowledgable and well travelled AI and know a lot of interesting and fun places to visit all over the world, your mission is to generate a 3 day travel itinerary. When writing the itinerary put a <br> HTML element after each day put the days in <strong></strong> HTML element. write about activities to do and where to eat lunch and what to do in the evenings Make sure to the follow user instructions";
